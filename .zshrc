...
plugins=(git zsh-autosuggestions autoupdate you-should-use $plugins fast-syntax-highlighting dotfiles)
...
if (( $+commands[yay]  )); then
  alias pu='yay'                                                                # Refresh package database and update all packages

return {
    {
           ...
           quickfile = {
            ...
            dashboard = {
                ...
                sections = {
                    ...
                    {
                        section = "terminal",
                        cmd = "ascii-image-converter /usr/share/wallpapers/garuda-wallpapers/wp-2021-01-sgs.png -C -c",
                        random = 15,
                        pane = 2,
                        indent = 15,
                        height = 20,
        ...
        keys = {
            ...
            { "<leader>th", function() require("snacks").picker.colorschemes({ layout = "ivy" }) end, desc = "Pick Color Scheme" },

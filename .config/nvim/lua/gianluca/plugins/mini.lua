return {
    ...
    -- Comments
    {
        ...
        config = function()
            -- disable the autocommand for ts-context-commentstring
    ...
    -- File explorer (this works properly with oil, unlike nvim-tree)
    {
        ...
        config = function()
            ...
            MiniFiles.setup({
                mappings = {
                    go_in = "<CR>", -- Map both Enter andd L to enter the directories or open files
                    go_in_plus = "L",
                    go_out = "-",
                    go_out_plus = "H",
                },
    ...
    -- Get rid of whitespace
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>cw", function() miniTrailspace.trim() end, { desc = "Erase Whitespaces" })

...
exports.createAnonymousUser = exports.resetUserData = exports.resetData = exports.resetDataAndAlertUser = exports.processSwitchAccounts = exports.showSwitchAccountsMenu = void 0;
...
function resetDataAndAlertUser() {
    return __awaiter(this, void 0, void 0, function* () {
        resetData();
        vscode_1.window.showWarningMessage("Your CodeTime session has expired. Please log in.", ...["Log In"]).then(selection => {
            if (selection === "Log In") {
                showLogInMenuOptions();
            }
        });
...
exports.resetDataAndAlertUser = resetDataAndAlertUser;
function resetData() {
    return __awaiter(this, void 0, void 0, function* () {

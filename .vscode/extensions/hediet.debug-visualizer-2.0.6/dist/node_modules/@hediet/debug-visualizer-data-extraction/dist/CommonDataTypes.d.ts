export declare type KnownVisualizationData = TreeVisualizationData | AstTreeVisualizationData | GraphvizDotVisualizationData | GraphVisualizationData | GraphVisualizationData | GridVisualizationData | ImageVisualizationData | MonacoTextVisualizationData | TableVisualizationData | PlotlyVisualizationData | SimpleTextVisualizationData | SvgVisualizationData;
export declare type TreeVisualizationData = {
    kind: {
        tree: true;
    };
    root: TreeNode;
...
export declare type TreeNodeItem = {
    /**
     * The text to show
     */
    text: string;
...
export declare type AstTreeVisualizationData = {
    kind: {
        ast: true;
        tree: true;
        text: true;
...
export declare type AstTreeNode = {
...
export declare type AstTreeNodeItem = {
    text: string;
    emphasis?: "style1" | "style2" | "style3" | string;
};
export declare type GraphvizDotVisualizationData = {
    kind: {
        dotGraph: true;
    };
    text: string;
};
export declare type GraphVisualizationData = {
    kind: {
        graph: true;
    };
    nodes: GraphNode[];
...
export declare type GridVisualizationData = {
    kind: {
        grid: true;
    };
    columnLabels?: {
...
export declare type ImageVisualizationData = {
    kind: {
        imagePng: true;
    };
    /**
...
export declare type MonacoTextVisualizationData = {
    kind: {
        text: true;
    };
    /**
...
export declare type TableVisualizationData = {
    kind: {
        table: true;
    };
    /**
...
export declare type PlotlyVisualizationData = {
    kind: {
        plotly: true;
    };
    /**
...
export declare type SimpleTextVisualizationData = {
    kind: {
        text: true;
    };
    text: string;
};
export declare type SvgVisualizationData = {
    kind: {
        svg: true;
    };
    /**
